...
export default function Lanyard({
  ...
  // Keeping these as URLs means you do NOT need to import .glb/.png files
  // or change Vite's assetsInclude setting.
  cardModel = '/assets/lanyard/card.glb',
}) {
...
function Band({
  ...
  const texture = useTexture(lanyardImage || '/assets/lanyard/lanyard-pattern.svg');
